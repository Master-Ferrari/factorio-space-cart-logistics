...
-- регистратор затирает предыдущих). Раньше gui.lua, style_browser.lua и
-- reorder_demo.lua каждый звал script.on_event(on_gui_click, ...) — последний
-- (ReorderDemo) затирал клики основного GUI, и почти все кнопки переставали работать.
