...
-- × bg своей раскладки. Слои гарантируют порядок: ВСЕ подложки на
-- entity-info-icon, ВСЕ иконки/значки на entity-info-icon-above — подложки
-- всегда ниже.
...
-- bg — размер подложки как доля от размера иконки. Числа подобраны на глаз.
local LAYOUTS = {
  [1] = { scale = 0.62, bg = 0.70, { 0, 0 } },
  [2] = { scale = 0.40, bg = 0.705, { -0.19, 0 }, { 0.19, 0 } },
  [3] = { scale = 0.37, bg = 0.715, { -0.19, -0.17 }, { 0.19, -0.17 }, { 0, 0.17 } },
  [4] = { scale = 0.37, bg = 0.735, { 0, -0.25 }, { -0.25, 0 },
                                    { 0.25, 0 }, { 0, 0.25 } },
  [5] = { scale = 0.29, bg = 0.735, { 0, -0.27 }, { -0.27, 0 },
                                    { 0.27, 0 }, { 0, 0.27 }, { 0, 0 } },
}
...
function Overlay.draw(rec, e, inv)
  ...
  local bg_scale = L.scale * L.bg * 64 / 53
  for i = 1, n do
